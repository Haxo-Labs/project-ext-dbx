...
while [[ $# -gt 0 ]]; do
	...
	--help)
		...
		echo ""
		echo "Examples:"
		echo "  $0 --backend-url redis://localhost:6379"
		echo "  $0 --backend-url redis://user:pass@redis.com:6379 --port 8080"
		echo "  $0 --backend-url redis://localhost:6379 --image effortlesslabs/dbx:latest"
		exit 0
		;;
	*)
